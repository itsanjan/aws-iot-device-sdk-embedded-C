This a simple for of the AWS IOT SDK.
[![Build Status](https://travis-ci.org/itsanjan/aws-iot-device-sdk-embedded-C.svg?branch=master)](https://travis-ci.org/itsanjan/aws-iot-device-sdk-embedded-C)
